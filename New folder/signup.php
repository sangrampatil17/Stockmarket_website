...
<body>
	<div class="container">
		...
		<form action="<?php echo $url; ?>reg.php" method="POST">
			...
			<label for="name">Start Date & End Date</label>
			<input type="Date" id="name" name="startdate" required>
			<input type="Date" id="name" name="enddate" required>
             <br><br>
		...
		<div class="form-footer">
			...
			<!-- <p>By clicking "Sign Up", you agree to our <a href="#">Terms of Service</a> and <a href="#">Privacy -->
					<!-- Policy</a>.</p> -->
		</div>
	</div>
</body>
